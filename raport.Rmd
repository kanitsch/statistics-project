...
* Funkcje:
  - Alpine01 (Minimum globalne: $f_{\min} = 0$)
  - Alpine02 (Minimum globalne: $f_{\min}(n) \approx (-1) \cdot 6.1295^{\lfloor n / 2 \rfloor} \cdot 2.1828^{(n \bmod 2)}$, gdzie n to liczba wymiarów
)
